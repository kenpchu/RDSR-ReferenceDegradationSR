...
from trainer.rdsrdisctrainerv84 import RDSRDiscTrainerV84
...
def train(conf, tb_logger, tar_path_list, ref_path_list, timestamp='', gt_tar='', gt_ker='', gt_ref=''):
    ...
    for idx, target_path in enumerate(tar_path_list):
        ...
        trainer = RDSRDiscTrainerV84(conf, tb_logger, test_dataloader, kernel=ker_gt_path, filename=tar_name, timestamp=timestamp)
